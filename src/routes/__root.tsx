...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Empório especializado em produtos naturais, suplementos e frigorífico. Faça seu pedido pelo WhatsApp!" },
      { property: "og:description", content: "Empório especializado em produtos naturais, suplementos e frigorífico. Faça seu pedido pelo WhatsApp!" },
      { name: "twitter:description", content: "Empório especializado em produtos naturais, suplementos e frigorífico. Faça seu pedido pelo WhatsApp!" },
